...
<div class="container mt-4">
    ...
    <h2 class="text-center mb-4">
        <i class="bi bi-pencil-square"></i> Actualizar Zona de Pesca
    </h2>
    ...
    <form action="<?= site_url('/user/zonasPesca/' . $zonaPesca->id) ?>" method="post">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="nombre" oninput="limitDigits(this, 50)" id="nombre" class="form-control" value="<?= old('nombre', $zonaPesca->nombre) ?>" placeholder="Nombre" required>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <textarea name="descripcion" oninput="limitDigits(this, 200)" id="descripcion" class="form-control" placeholder="Descripción"><?= old('descripcion', $zonaPesca->descripcion) ?></textarea>
        </div>
