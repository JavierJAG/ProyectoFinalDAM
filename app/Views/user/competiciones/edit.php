...
<input type="hidden" name="_method" value="PATCH">
    ...
    <input type="text" name="nombre" id="nombre" value="<?= old('nombre', $competicion->nombre) ?>" placeholder="Nombre de la competicion" required>

    <label for="fecha_inicio">Fecha de inicio</label>
    <input type="datetime-local" name="fecha_inicio" id="fecha_inicio" value="<?= old('fecha_inicio', $competicion->fecha_inicio) ?>" required>

    <label for="fecha_fin">Fecha de fin</label>
    <input type="datetime-local" name="fecha_fin" id="fecha_fin" value="<?= old('fecha_fin', $competicion->fecha_fin) ?>" required>
    ...
    <textarea name="descripcion" id="descripcion" placeholder="Descripción de la competicion"><?= old('descripcion', $competicion->descripcion) ?></textarea>
    ...
    <?php if (!empty($imagenes)): ?>
        ...
        <ul>
            <?php foreach ($imagenes as $imagen): ?>
                <li>
                    <img src="<?= base_url('uploads/competiciones/' . $imagen->imagen) ?>" alt="Imagen de <?= esc($competicion->nombre) ?>" width="100">
                </li>
            <?php endforeach; ?>
        </ul>
    <?php endif; ?>
